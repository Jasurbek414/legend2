...
const Materials = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('api/material-transactions'); // Replace YOUR_BASE_URL with the appropriate URL
  ...
  return (
    <Table columns={columns} dataSource={material} pagination={false} />
  );
};
